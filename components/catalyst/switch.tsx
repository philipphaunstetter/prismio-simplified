...
const colors = {
  ...
  outline: [
    // Checked state: [bg-ring, bg] for the outer switch
    '[--switch-bg-ring:var(--color-gray-500)] [--switch-bg:var(--color-gray-400)]',
    // Checked state: [ring, shadow, switch] for the inner toggle dot  
    '[--switch-ring:var(--color-gray-500)] [--switch-shadow:var(--color-black)]/10 [--switch:white]',
  ],
}
  ...
  return (
    <Headless.Switch
      ...
      className={clsx(
        ...
        // Unchecked - default fallback
        color !== 'outline' ? 'bg-zinc-200 ring-1 ring-black/5 ring-inset' : '',
        // Unchecked - outline variant
        color === 'outline' ? 'bg-gray-100 ring-1 ring-gray-300 ring-inset' : '',
        // Checked
